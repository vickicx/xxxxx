...
- (void)layoutSubviews
{
    ...
    self.firstLabel.frame = CGRectMake(5 * kWIDTH, 0, cWIDTH + 10 * kWIDTH, cHEIGHT);
...
//    self.firstLabel.backgroundColor = [UIColor yellowColor];
    ...
    self.secondLabel.frame = CGRectMake(cWIDTH + 5 * kWIDTH, 0, cWIDTH + 5 * kWIDTH, cHEIGHT);
...
//    self.secondLabel.backgroundColor = [UIColor redColor];
    ...
    self.thirdLabel.frame = CGRectMake(cWIDTH * 2 + 5 * kWIDTH, 0, cWIDTH + 5 * kWIDTH, cHEIGHT);
...
//    self.thirdLabel.backgroundColor = [UIColor yellowColor];
    ...
    self.fourthLabel.frame = CGRectMake(cWIDTH * 3 + 10 * kWIDTH, 0, cWIDTH + 5 * kWIDTH, cHEIGHT);
...
//    self.fourthLabel.backgroundColor = [UIColor redColor];
    ...
    self.fifthLabel.frame = CGRectMake(cWIDTH * 4, 0, cWIDTH + 5 * kWIDTH, cHEIGHT);
